    ...
    if (w==true){
         ...
         switch(_.z.zlk){
             case "Administrador":
                ...
                elm = '<li><a id="actividadbtn" onclick="display_Panel(this); Activity();" class="actividadGeneral" href="#!"><i class="material-icons left">timeline</i>Actividad</a></li>';
                ...
                */
                ...
                elm = '<ul id="user_options" class="dropdown-content grey lighten-3"><li><a id="userbtn" onclick="display_Panel(this); MyActivity();" class="actividad" href="#!"><i class="material-icons left">person</i>Usuario</a></li><li class="divider"></li><li><a onclick="signOut()" href="#!"><i class="material-icons left">exit_to_app</i>Cerrar sesión</a>';
                $( "#nav-mobile" ).append( elm );
                 
                 
                 elm = '<li class="no-padding"><ul class="collapsible collapsible-accordion" style="padding-top: 0px;"><li><a class="collapsible-header"><span id="mobile-username">'+_user.nombre+' '+_user.primer_apellido+' '+_user.segundo_apellido+'</span><i class="material-icons">account_circle</i><i class="material-icons right">arrow_drop_down</i></a><div class="collapsible-body"><ul id=""><li><div class="divider"></div></li><li><a onclick="document.getElementById('+"'userbtn'"+').click(); $('+"'.button-collapse'"+').sideNav('+"'hide'"+');" class="actividad" href="#!"><i class="material-icons left">person</i>Usuario</a></li><li><a onclick="signOut()" href="#!"><i class="material-icons left">exit_to_app</i>Cerrar sesión</a></li></ul></div></li></ul></li><li><div class="divider"></div></li><div id="mobile-currentTasks"></div>';
                 
                 $( "#slide-out" ).append( elm );
                 $('.collapsible').collapsible();
                 
                 
                 elm ='<li class="no-padding"><a onclick="document.getElementById('+"'solicitudesbtn'"+').click(); $('+"'.button-collapse'"+').sideNav('+"'hide'"+');" href="#!"><i class="material-icons left">announcement</i>Solicitudes<span class="badge" id="mobile-badge">0</span></a></li>';
                 $( "#mobile-currentTasks" ).append( elm );
                 
                 elm='<li class="no-padding"><a onclick="document.getElementById('+"'actividadbtn'"+').click(); $('+"'.button-collapse'"+').sideNav('+"'hide'"+');" href="#!"><i class="material-icons left">timeline</i>Actividad </a></li>';
                 $( "#mobile-currentTasks" ).append( elm );
             ...
             case "Soporte": //SOPORTEEEEEEEEEEEEEEEEEEE
                
               
                elm = '<li><a id="solicitudesbtn" onclick="display_Panel(this); historySlctdsSp();" class="solicitudes grey-text text-lighten-2" href="#!"><i class="material-icons left">announcement</i>Solicitudes<span id="solicitudes-badge" class="badge white-text">0</span></a></li>';
                $( "#nav-mobile" ).append( elm );
             ...
             case "Estudiante":
                ...
                elm = '<ul id="user_options" class="dropdown-content grey lighten-3"><li><a id="userbtn" onclick="display_Panel(this); myHistorySolicitudes();" class="actividad" href="#!"><i class="material-icons left">person</i>Usuario</a></li><li class="divider"></li><li><a onclick="signOut()" href="#!"><i class="material-icons left">exit_to_app</i>Cerrar sesión</a>';
                $( "#nav-mobile" ).append( elm );
...
function displayEspacios(espacios, b){
    ...
    if (b==true){
        var filtro_planta=document.getElementById("espacios-filtro-planta").childNodes;
        for (var i=0; i<filtro_planta.length; i++){
            if (filtro_planta[i].nodeName=="OPTION"){
                if (filtro_planta[i].selected==true){
                    filtro_planta[i].selected=false;
                }
            }
        }
        filtro_planta[0].selected=true;
        $('#espacios-filtro-planta').material_select();
        document.getElementById("espacios-filtro-codigo").value="";//input
        Materialize.updateTextFields();
    }
}
...
function displayActivos(activos, b){
    ...
    if (b==true){
        var filtro_tipo=document.getElementById("activos-filtro-tipo").childNodes;
        for (var i=0; i<filtro_tipo.length; i++){
            if (filtro_tipo[i].nodeName=="OPTION"){
                if (filtro_tipo[i].selected==true){
                    filtro_tipo[i].selected=false;
                }
            }
        }
        filtro_tipo[0].selected=true;
        $('#activos-filtro-tipo').material_select();
        
        
        var filtro_espacio=document.getElementById("activos-filtro-espacio").childNodes;
        for (var i=0; i<filtro_espacio.length; i++){
            if (filtro_espacio[i].nodeName=="OPTION"){
                if (filtro_espacio[i].selected==true){
                    filtro_espacio[i].selected=false;
                }
            }
        }
        filtro_espacio[0].selected=true;
        $('#activos-filtro-espacio').material_select();
        document.getElementById("activos-filtro-codigo").value="";//input
        document.getElementById("activos-filtro-ci").value="";//input
        Materialize.updateTextFields();
    }
}
// HEAD
...
function displayUsuarios(usuarios, b){
    ...
    if (b==true){
        var filtro_tipo=document.getElementById("usuarios-filtro-tipo").childNodes;
        for (var i=0; i<filtro_tipo.length; i++){
            if (filtro_tipo[i].nodeName=="OPTION"){
                if (filtro_tipo[i].selected==true){
                    filtro_tipo[i].selected=false;
        ...
        filtro_tipo[0].selected=true;
        $('#usuarios-filtro-tipo').material_select();
        document.getElementById("usuarios-filtro-correo").value="";//input
        Materialize.updateTextFields();
    }
}
...
function eliminarX(id){
    ...
    for (var i=0; i<checked.length; i++){
        if (checked[i].id==_user.id){
            $('#loading').modal('close');
            var $toastContent = $('<span><i class="material-icons left">error</i> Error fatal no es posible completar está acción</span>');
            Materialize.toast($toastContent, 5000, "red");
            $('#loading').modal('open');
        }else{
    ...
    if (messenger.elementos.length>0){
        $.ajax({
            type: "POST",
                ...
                success: function(res){
                    if (res.resultado == true){
                        ...
                        if (res.tipo=="Administrador"){
                           ...
                           d.getElementById("solicitudes-badge").innerHTML=c;                             d.getElementById("mobile-badge").innerHTML=c;
...
function displayMyActivity(actividad, b){
    ...
    if (b==true){
        var filtro_accion=document.getElementById("myActividad-filtro-accion").childNodes;
        for (var i=0; i<filtro_accion.length; i++){
            if (filtro_accion[i].nodeName=="OPTION"){
                if (filtro_accion[i].selected==true){
                    filtro_accion[i].selected=false;
                }
            }
        }
        filtro_accion[0].selected=true;
        $('#myActividad-filtro-accion').material_select();
        
        var filtro_elemento=document.getElementById("myActividad-filtro-elemento").childNodes;
        for (var i=0; i<filtro_elemento.length; i++){
            if (filtro_elemento[i].nodeName=="OPTION"){
                if (filtro_elemento[i].selected==true){
                    filtro_elemento[i].selected=false;
                }
            }
        }
        filtro_elemento[0].selected=true;
        $('#myActividad-filtro-elemento').material_select();
        
        document.getElementById("myActividad-filtro-id").value="";//input
        Materialize.updateTextFields();
    }
}
...
function displayActivity(actividad, b){
    ...
    if (b==true){
        var filtro_accion=document.getElementById("actividad-filtro-accion").childNodes;
        for (var i=0; i<filtro_accion.length; i++){
            if (filtro_accion[i].nodeName=="OPTION"){
                if (filtro_accion[i].selected==true){
                    filtro_accion[i].selected=false;
        ...
        filtro_accion[0].selected=true;
        $('#actividad-filtro-accion').material_select();
        
        var filtro_elemento=document.getElementById("actividad-filtro-elemento").childNodes;
        for (var i=0; i<filtro_elemento.length; i++){
            if (filtro_elemento[i].nodeName=="OPTION"){
                if (filtro_elemento[i].selected==true){
                    filtro_elemento[i].selected=false;
        ...
        filtro_elemento[0].selected=true;
        $('#actividad-filtro-elemento').material_select();
        
        document.getElementById("actividad-filtro-id").value="";//input
        document.getElementById("actividad-filtro-correo").value="";//input
        Materialize.updateTextFields();
    }
}
...
function fnExcelReport() {
    ...
    for (var i=0; i<_activos.length; i++){
        var display= "<tr><td>"+_activos[i].codigo+"</td><td>"+_activos[i].codigoInstitucional+"</td><td>"+_activos[i].tipo+"</td><td>"+_activos[i].descripcion+"</td><td>"+_activos[i].espacio+"</td></tr>"
        $( "#inventarioBody" ).append( display ); 
    }
    var tab_text="<table ><tr>";
    var textRange; var j=0;
    tab = document.getElementById("inventario"); 
